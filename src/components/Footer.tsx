    ...
    <section className="py-24 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        <motion.div
          ...
          className="max-w-4xl mx-auto bg-white border border-border p-8 md:p-12 rounded-3xl shadow-xl"
        >
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center gap-4 sm:gap-6">
            <Link href="/sell-your-junk-car" className="w-full sm:w-auto">
              <Button size="lg" className="h-14 md:h-16 px-8 md:px-10 text-lg md:text-xl bg-primary hover:bg-primary/90 text-white shadow-lg shadow-primary/20 transition-all duration-300 w-full rounded-full">
                Get Instant Quote
              </Button>
            </Link>
            <Link href="/contact" className="w-full sm:w-auto">
              <Button size="lg" variant="outline" className="h-14 md:h-16 px-8 md:px-10 text-lg md:text-xl border-primary/20 text-primary hover:bg-primary/5 transition-all duration-300 w-full rounded-full group">
  ...
  return (
    <footer className="bg-foreground text-white pt-20 pb-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row items-center justify-between text-sm text-gray-400 gap-4 text-center md:text-left">
          <p>© {new Date().getFullYear()} Arrowhead Digitech. All rights reserved.</p>
          <p>
